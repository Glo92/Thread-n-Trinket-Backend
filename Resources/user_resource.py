...
class RegisterResource(Resource):
    def post(self):
        ...
        return {'message': 'User registered successfully and email sent', 'user': user.serialize()}, 201
...
class LoginResource(Resource):
    def post(self):
        ...
        return {'message': 'Login successful', 'access_token': access_token, 'user': user.serialize()}, 200
